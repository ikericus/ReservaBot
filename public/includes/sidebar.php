    ...
    <div class="flex-1 flex flex-col pt-6 pb-4 overflow-y-auto">
        <nav class="flex-1 px-4 space-y-2">
            ...
            <div class="space-y-1">
                ...
                <a href="/dia" class="nav-item <?php echo $currentPage === 'calendario' ? 'active text-purple-700 font-semibold' : 'text-gray-700 hover:text-purple-600'; ?> group flex items-center px-4 py-3 text-sm font-medium rounded-xl">
...
// Agregar estilos CSS para las animaciones del menú
