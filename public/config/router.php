...
class Router {
    ...
    private function defineRoutes() {
        ...
        $this->addRoute('GET',      '/terminos',                        'pages/docs/terminos.php');  
        $this->addRoute('GET',      '/politica-privacidad',             'pages/docs/politica-privacidad.php');  
        $this->addRoute('GET',      '/politica-cookies',                'pages/docs/politica-cookies.php');  
        ...
        $this->addRoute('POST',     '/api/clientes-buscar',                     'api/clientes-buscar.php',                   ['auth']);
    ...
    private function handleError(Exception $e) {
        ...
        include PROJECT_ROOT . '/pages/errors/500.php';
        exit;
    }
